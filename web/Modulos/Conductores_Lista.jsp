                ...
                <div class="table-responsive">
                    <table class="table table-striped table-bordered table-hover text-center ">
                        <tr style="font-size: 0.85em">
                            ...
                            <th class="text-center">Vencimiento de Licencia</th>
                            <th class="text-center" style="width: 120px;">Vencimiento permiso conducir vehículos del estado</th>
                            <th class="text-center">Foto del chofer</th>
                            <th class="text-center">Foto de la licencia chofer</th>
                            <th class="text-center">Foto del permiso para conducir vehículos del estado</th>

                        </tr>
                        <%                                               
                            for (int i = 0; i < Lista.size(); i++) {
                                out.println("<tr>"
                                        + "<td>" + Lista.get(i).getCed() + "</td>"
                                        + "<td>" + Lista.get(i).getNom() + "</td>"
                                        + "<td>" + Lista.get(i).getAp1() + "</td>"
                                        + "<td>" + Lista.get(i).getAp2() + "</td>"
                                        + "<td>" + Lista.get(i).getNumtel() + "</td>"
                                        + "<td>" + Lista.get(i).getVencimientoLicencia() + "</td>"
                                        + "<td>" + Lista.get(i).getVencimientoEstadoLicencia() + "</td>"
                                        + "<td> <img max-height='60'  width='100' src='../imagen/" + Lista.get(i).getRutaFoto() + "'></td>"
                                        + "<td> <img max-height='60' width='100' src='../imagen/" + Lista.get(i).getRutaLicencia() + "'></td>"
                                        + "<td> <img max-height='60' width='100' src='../imagen/" + Lista.get(i).getRutaEstadoLicencia() + "'></td>"
                                        + "</tr>");
                            }
                        %>
                    </table>  
