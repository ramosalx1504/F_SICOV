 ...
 * @author pc
 */
@WebServlet(name = "ServletMantenimientoConductor", urlPatterns = {"/ServletMantenimientoConductor"})
public class ServletMantenimientoConductor extends HttpServlet {
     ...
     */
        ...
        try {
            ...
            System.err.println(vencimientoLicencia1);
            System.err.println(vencimientoEstadoLicencia1);
    ...
    if(c.existeChofer(ced)){
        c.ActualizarChofer(ced, nom, ap1, ap2, numtel, rutaFoto, rutaLicencia, rutaEstadoLicencia,
